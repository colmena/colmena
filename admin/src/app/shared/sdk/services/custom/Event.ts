...
export class EventApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public create(data: any = undefined): Observable<Event> {
   ...
   * </em>
   */
  public upsert(data: any = undefined): Observable<Event> {
   ...
   * </em>
   */
  public upsertWithWhere(where: any = undefined, data: any = undefined): Observable<Event> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public findById(id: any, filter: LoopBackFilter = undefined): Observable<Event> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Events/:id";
    let routeParams: any = {
   ...
   * </em>
   */
  public find(filter: LoopBackFilter = undefined): Observable<Array<Event>> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Events";
    let routeParams: any = {};
   ...
   * </em>
   */
  public findOne(filter: LoopBackFilter = undefined): Observable<Event> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Events/findOne";
    let routeParams: any = {};
   ...
   * </em>
   */
  public createMany(data: Array<any> = undefined): Observable<Array<Event>> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Events";
    let routeParams: any = {};
