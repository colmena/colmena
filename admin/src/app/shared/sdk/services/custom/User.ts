...
export class UserApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public updateByIdRoles(id: any, fk: any, data: any = undefined): Observable<any> {
    let method: string = "PUT";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/roles/:fk";
    let routeParams: any = {
   ...
   * </em>
   */
  public linkRoles(id: any, fk: any, data: any = undefined): Observable<any> {
    let method: string = "PUT";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public getRoles(id: any, filter: LoopBackFilter = undefined): Observable<any> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/roles";
    let routeParams: any = {
   ...
   * </em>
   */
  public createRoles(id: any, data: any = undefined): Observable<any> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/roles";
    let routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countRoles(id: any, where: any = undefined): Observable<any> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createManyRoles(id: any, data: Array<any> = undefined): Observable<any> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/roles";
    let routeParams: any = {
