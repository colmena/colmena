...
export class ProductApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public create(data: any = undefined): Observable<Product> {
    ...
    let urlParams: any = {};
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instance: Product) => new Product(instance));
  }
   ...
   * </em>
   */
  public upsert(data: any = undefined): Observable<Product> {
   ...
   * </em>
   */
  public upsertWithWhere(where: any = undefined, data: any = undefined): Observable<Product> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public findById(id: any, filter: LoopBackFilter = undefined): Observable<Product> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Products/:id";
    let routeParams: any = {
   ...
   * </em>
   */
  public find(filter: LoopBackFilter = undefined): Observable<Array<Product>> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Products";
    let routeParams: any = {};
    ...
    if (filter) urlParams.filter = filter;
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instances: Array<Product>) =>
        instances.map((instance: Product) => new Product(instance))
    );
  }
   ...
   * </em>
   */
  public findOne(filter: LoopBackFilter = undefined): Observable<Product> {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Products/findOne";
    let routeParams: any = {};
   ...
   * </em>
   */
  public createMany(data: Array<any> = undefined): Observable<Array<Product>> {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Products";
    let routeParams: any = {};
