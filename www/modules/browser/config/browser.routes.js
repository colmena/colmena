...
app.config(function ($stateProvider) {
  $stateProvider.state('app.browser', {
    ...
    resolve: {
      models: ['MetaService', function (MetaService) {
    ...
    resolve: {
      model: ['$stateParams', 'MetaService', function ($stateParams, MetaService) {
    ...
    resolve: {
      ...
      items: ['$stateParams', 'MetaService', function ($stateParams, MetaService) {
    ...
    resolve: {
      item: ['$stateParams', 'MetaService', function ($stateParams, MetaService) {
    ...
    controllerAs: 'edit',
    controller: ['$state', 'MetaService', 'model', 'item', 'itemFields',
    ...
    resolve: {
      ...
      itemFields: ['$stateParams', 'MetaService', 'model', function ($stateParams, MetaService, model) {
    ...
    controllerAs: 'add',
    controller: ['$state', 'MetaService', 'model', 'itemFields',
    ...
    url: '/:modelId/delete',
    template: '',
    controller: ['$state', '$stateParams', 'MetaService', 'model', function ($state, $stateParams, MetaService, model) {
