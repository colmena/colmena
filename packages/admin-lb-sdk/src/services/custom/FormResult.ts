...
/**
 * Api services for the `FormResult` model.
 *
 * **Details**
 *
 * Forms: Manage Results
 */
@Injectable()
export class FormResultApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `FormResult` object.)
   * </em>
   */
  public getForm(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public summary(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FormResults/:id/summary";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
