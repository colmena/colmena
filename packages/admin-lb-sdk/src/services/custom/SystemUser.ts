...
export class SystemUserApi extends BaseLoopBackApi {
  ...
  /**
   * Queries formResults of SystemUser.
   *
   * @param {any} id SystemUser id
   *
   * @param {object} filter 
  ...
  /**
   * Counts formResults of SystemUser.
   *
   * @param {any} id SystemUser id
   *
   * @param {object} where Criteria to match model instances
