...
/**
 * Api services for the `Form` model.
 *
 * **Details**
 *
 * Forms: Manage Forms
 */
@Injectable()
export class FormApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} fk Foreign key for results
   *
   ...
   * </em>
   */
  public findByIdResults(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   */
  public destroyByIdResults(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateByIdResults(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getResults(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Forms/:id/results";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createResults(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * This method returns no data.
   */
  public deleteResults(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Forms/:id/results";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countResults(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Forms/:id/results/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyResults(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Forms/:id/results";
    let _routeParams: any = {
